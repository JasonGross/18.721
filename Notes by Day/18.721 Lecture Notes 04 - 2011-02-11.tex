...
\setcounter {section}{3}\section {Friday, February 11, 2011}
  ...
  \begin{eg*}
    ...
    The flexes: You can eliminate $z$ from $f = H(f) = 0$.  Then you get a homogeneous polynomial in $x$ and $y$.  You can solve for $x / y$, let $y$ be 1, and then plug back in and solve for $z$.  In this example, we get that one of the flex points is at $(x, y, z) = (0, 0, 1)$.
  \end{eg*}
