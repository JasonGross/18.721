...
\begin{notessection}{2}{25}{2011}
  ...
  $V(I) = \{\mathcal M\text{ that contains }I\}$ \\
...
\begin{notessection}{2}{28}{2011}
  ...
  $$
  \xymatrix{
    B \ar[r]^{\pi \circ p} \ar@{{}{}*{\cup}}[d] & \mathbb C \\ % fix
    A \ar@{-->}[ur]_{\pi_p}
  }
  $$
  ...
  $$
  \xymatrix{
    B \ar[r]_{\sigma} \ar@{{}{}*{\cup}}[d] \ar@/^/[rr]^{\pi} & B \ar[r]_{\pi_q} \ar@{{}{}*{\cup}}[d] & \mathbb C \ar@{=}[d] \\
    A \ar[r]^{\text{id}} \ar@/_/[rr]_{\pi_p} & A \ar[r]^{\pi_p} & \mathbb C
  }
  $$
